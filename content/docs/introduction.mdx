---
title: Introducción
description: "CompoDex es una biblioteca de componentes de interfaz de usuario inspirada en Pokémon, diseñada para ayudar a los desarrolladores a crear aplicaciones web con temática Pokémon de manera rápida y sencilla."
